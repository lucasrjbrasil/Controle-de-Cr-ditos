...
export function CompanyProvider({ children }) {
    ...
    const addCompany = async (newCompany) => {
        ...
        try {
            const companyToSave = {
                ...newCompany,
                // ID is generated by DB (or we can let DB do it)
                // We'll let DB generate ID if we ommit it, but local state needs it immediately?
                // Best practice: insert and use returned data
            };
